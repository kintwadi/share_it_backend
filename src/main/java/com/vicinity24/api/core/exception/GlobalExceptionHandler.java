package com.vicinity24.api.core.exception;

import com.vicinity24.api.core.insurance.exception.InvalidInsuranceTypeException;
import com.vicinity24.api.core.insurance.exception.ResourceNotFoundException;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<Map<String, String>> handleInvalidInsuranceType(InvalidInsuranceTypeException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST).body(Map.of("error", ex.getMessage()));
    }

    @ExceptionHandler(ResourceNotFoundException.class)
    public ResponseEntity<Map<String, String>> handleInsuranceNotFound(ResourceNotFoundException ex) {
