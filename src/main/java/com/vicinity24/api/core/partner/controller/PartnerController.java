package com.vicinity24.api.core.partner.controller;

import com.vicinity24.api.core.dto.ListingDTO;
...
import com.vicinity24.api.core.partner.service.PartnerService;
...
public class PartnerController {
    ...
    @GetMapping("/listings")
    public ResponseEntity<List<ListingDTO>> listings(@AuthenticationPrincipal org.springframework.security.core.userdetails.User principal) {
        User current = userService.getByEmail(principal.getUsername());
    ...
    public ResponseEntity<ListingDTO> approveRequest(
            @AuthenticationPrincipal org.springframework.security.core.userdetails.User principal,
            @PathVariable("listingId") UUID listingId) {
        User current = userService.getByEmail(principal.getUsername());
    ...
    public ResponseEntity<ListingDTO> rejectRequest(
            @AuthenticationPrincipal org.springframework.security.core.userdetails.User principal,
            @PathVariable("listingId") UUID listingId) {
        User current = userService.getByEmail(principal.getUsername());
    ...
    public ResponseEntity<ReturnDTOs.ReturnSessionResponse> acceptManualReturn(
            @AuthenticationPrincipal org.springframework.security.core.userdetails.User principal,
            @PathVariable("listingId") UUID listingId) {
        User current = userService.getByEmail(principal.getUsername());
    ...
    public ResponseEntity<ReturnDTOs.ReturnSessionResponse> denyManualReturn(
            @AuthenticationPrincipal org.springframework.security.core.userdetails.User principal,
            @PathVariable("listingId") UUID listingId,
