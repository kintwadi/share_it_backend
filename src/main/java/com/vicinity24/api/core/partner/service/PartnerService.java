package com.vicinity24.api.core.partner.service;

import com.vicinity24.api.core.dto.*;
...
import com.vicinity24.api.core.partner.dto.PartnerBorrowRequestDTO;
import com.vicinity24.api.core.partner.dto.PartnerCreateListingRequest;
import com.vicinity24.api.core.partner.dto.PartnerDTO;
import com.vicinity24.api.core.partner.dto.PartnerRegistrationRequest;
import com.vicinity24.api.core.partner.dto.PartnerReturnRequestDTO;
import com.vicinity24.api.core.partner.dto.PartnerSettingsDTO;
...
import com.vicinity24.api.core.partner.repository.PartnerSettingsRepository;
...
import com.vicinity24.api.core.service.ReturnService;
import com.vicinity24.api.core.util.DistanceUtil;
...
public class PartnerService {
    ...
    public ListingDTO updatePartnerListing(User current, UUID listingId, PartnerCreateListingRequest req) {
        ...
        if (req.getPickupLocationId() != null) {
            ExchangeLocation pickup = exchangeLocationRepository.findById(req.getPickupLocationId())
                    .orElseThrow(() -> new RuntimeException("pickup_location_not_found"));
    ...
    public List<PartnerReturnRequestDTO> getPendingManualReturns(User current) {
        ...
        return returnSessionRepository
                .findByStatusAndManualBorrowerConfirmedAtIsNotNullAndManualLenderConfirmedAtIsNullOrderByCreatedAtDesc(ReturnStatus.PENDING)
                .stream()
    ...
    @Transactional
    public ReturnDTOs.ReturnSessionResponse acceptManualReturn(User current, UUID listingId) {
    ...
    @Transactional
    public ReturnDTOs.ReturnSessionResponse denyManualReturn(User current, UUID listingId, String reason) {
        Listing listing = listingRepository.findById(listingId).orElseThrow(() -> new RuntimeException("listing_not_found"));
        if (listing.getPartner() == null || listing.getPartner().getId() == null) throw new RuntimeException("not_partner_listing");
        requirePartnerAdmin(current, listing.getPartner().getId());
