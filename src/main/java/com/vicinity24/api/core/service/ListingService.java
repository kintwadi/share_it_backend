...
import com.vicinity24.api.core.dto.BorrowRequest;
import com.vicinity24.api.core.model.*;
import com.vicinity24.api.core.payment.PaymentManager;
import com.vicinity24.api.core.payment.StripePayment;
import com.vicinity24.api.core.repository.*;
...
public class ListingService {
    ...
    private final RecommendationDismissRepository dismissRepository;
    ...
    public ListingService(
            ...
            RecommendationDismissRepository dismissRepository,
    ...
    @Transactional
    public ListingDTO borrow(UUID id, User borrower, BorrowRequest request) {
        Listing l = listingRepository.findById(id).orElseThrow(() -> new RuntimeException("listing_not_found"));
    ...
    public void dismiss(User current, UUID listingId) {
        ...
        var rec = RecommendationDismiss.builder().id(UUID.randomUUID()).user(current).listing(l).createdAt(java.time.LocalDateTime.now()).build();
