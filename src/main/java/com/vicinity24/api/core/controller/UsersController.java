...
import com.vicinity24.api.core.dto.ChangePasswordRequest;
...
public class UsersController {
    ...
    public ResponseEntity<List<ActivityDTO>> activity(@AuthenticationPrincipal org.springframework.security.core.userdetails.User principal) {
        User u = userService.getByEmail(principal.getUsername());
