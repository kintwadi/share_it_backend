...
import com.vicinity24.api.core.dto.ChatMessageDTO;
import com.vicinity24.api.core.dto.MessageDTO;
import com.vicinity24.api.core.dto.PresenceUpdateDTO;
import com.vicinity24.api.core.model.Message;
import com.vicinity24.api.core.model.User;
import com.vicinity24.api.core.service.MessageService;
import com.vicinity24.api.core.service.PresenceService;
...
public class SocketMessagingController {
    ...
    public void send(ChatMessageDTO dto) {
        ...
        MessageDTO md = MessageDTO.builder()
                .id(m.getId())
