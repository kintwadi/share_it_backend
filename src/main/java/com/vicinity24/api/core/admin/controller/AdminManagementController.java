...
import com.vicinity24.api.core.admin.dto.AdminDisputeDTO;
import com.vicinity24.api.core.admin.dto.AdminListingDTO;
import com.vicinity24.api.core.admin.dto.AdminPageResponse;
import com.vicinity24.api.core.admin.dto.AdminSubscriptionDTO;
import com.vicinity24.api.core.admin.dto.AdminSummaryDTO;
import com.vicinity24.api.core.admin.dto.AdminTransactionDTO;
import com.vicinity24.api.core.admin.dto.AdminUserDTO;
import com.vicinity24.api.core.admin.service.AdminManagementService;
...
public class AdminManagementController {
    ...
    public AdminManagementController(AdminManagementService adminService, UserService userService) {
    ...
    @PostMapping("/partner/items/{listingId}/deactivate")
    public ResponseEntity<Map<String, String>> deactivatePartnerItem(
            @AuthenticationPrincipal org.springframework.security.core.userdetails.User principal,
            @PathVariable("listingId") UUID listingId) {
        User admin = userService.getByEmail(principal.getUsername());
        adminService.deactivatePartnerItem(admin, listingId);
        return ResponseEntity.ok(Map.of("status", "ok"));
    }
