...
import com.vicinity24.api.repository.MessageRepository;
import com.vicinity24.api.repository.PasswordResetTokenRepository;
import com.vicinity24.api.repository.RecommendationDismissRepository;
import com.vicinity24.api.repository.ReportRepository;
import com.vicinity24.api.repository.ReviewRepository;
import com.vicinity24.api.repository.SubscriptionRepository;
import com.vicinity24.api.repository.SubscriptionVerificationCodeRepository;
...
public class UserService {
    ...
    public List<com.vicinity24.api.dto.ActivityDTO> getActivity(User user) {
        List<com.vicinity24.api.dto.ActivityDTO> activity = new java.util.ArrayList<>();

        // Account created
        if (user.getJoinedDate() != null) {
            activity.add(new com.vicinity24.api.dto.ActivityDTO(
                "Joined Vicinity24",
                "Account created",
                user.getJoinedDate(),
                "account"
        ...
        // Subscriptions
        List<com.vicinity24.api.model.Subscription> subs = subscriptionRepository.findByUser(user);
        for (com.vicinity24.api.model.Subscription s : subs) {
