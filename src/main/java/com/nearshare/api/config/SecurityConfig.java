    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers("/api/auth/login", "/api/auth/register", "/api/auth/forgot-password", "/api/auth/verify-reset-code", "/api/auth/reset-password", "/api/admin/auth/login", "/api/admin/auth/register", "/api/partner/auth/login", "/api/partner/auth/register", "/api/config/**", "/api/enterprise/**", "/ws/**", "/v3/api-docs/**", "/swagger-ui/**", "/swagger-ui.html", "/api/payments/webhook", "/api/health", "/api/seed").permitAll()
