...
public class UsersController {
    ...
    public ResponseEntity<List<com.nearshare.api.dto.ActivityDTO>> activity(@AuthenticationPrincipal org.springframework.security.core.userdetails.User principal) {
        User u = userService.getByEmail(principal.getUsername());
