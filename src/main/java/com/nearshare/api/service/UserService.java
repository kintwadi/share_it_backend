...
import com.nearshare.api.repository.DeviceRepository;
...
import com.nearshare.api.repository.RecommendationDismissRepository;
...
public class UserService {
    ...
    public List<com.nearshare.api.dto.ActivityDTO> getActivity(User user) {
        List<com.nearshare.api.dto.ActivityDTO> activity = new java.util.ArrayList<>();

        // Account created
        if (user.getJoinedDate() != null) {
            activity.add(new com.nearshare.api.dto.ActivityDTO(
                "Joined NearShare",
                "Account created",
                user.getJoinedDate(),
                "account"
        ...
        // Subscriptions
        List<com.nearshare.api.model.Subscription> subs = subscriptionRepository.findByUser(user);
        for (com.nearshare.api.model.Subscription s : subs) {
