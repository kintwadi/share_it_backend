...
export const routes: Routes = [
  ...
  { path: 'settings/borrowing-subscription/unsubscribe', canMatch: [canMatchSettings], data: { action: 'unsubscribe-borrowing-subscription' }, loadComponent: () => import('./features/settings-action-confirm/settings-action-confirm.component').then(m => m.SettingsActionConfirmComponent) },
